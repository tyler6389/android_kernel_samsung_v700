...
enum v4l2_flash_mode {
	...
	FLASH_MODE_FILL_IN_RED_EYE,
	FLASH_MODE_SMART,
	FLASH_MODE_1st_CURTAIN,
	FLASH_MODE_2nd_CURTAIN,
	FLASH_MODE_MAX,
};
...
enum v4l2_contrast_ext_mode {
	CONTRAST_EXT_MINUS_4 = -4,
	CONTRAST_EXT_MINUS_3,
	CONTRAST_EXT_MINUS_2,
	CONTRAST_EXT_MINUS_1,
	CONTRAST_EXT_DEFAULT = 0,
	CONTRAST_EXT_PLUS_1,
	CONTRAST_EXT_PLUS_2,
	CONTRAST_EXT_PLUS_3,
	CONTRAST_EXT_PLUS_4,
...
enum v4l2_saturation_ext_mode {
	SATURATION_EXT_MINUS_4 = -4,
	SATURATION_EXT_MINUS_3,
	SATURATION_EXT_MINUS_2,
	SATURATION_EXT_MINUS_1,
	SATURATION_EXT_DEFAULT = 0,
	SATURATION_EXT_PLUS_1,
	SATURATION_EXT_PLUS_2,
	SATURATION_EXT_PLUS_3,
	SATURATION_EXT_PLUS_4,
	SATURATION_EXT_MAX,
};
...
enum v4l2_sharpness_ext_mode {
	SHARPNESS_EXT_MINUS_4 = -4,
	SHARPNESS_EXT_MINUS_3,
	SHARPNESS_EXT_MINUS_2,
	SHARPNESS_EXT_MINUS_1,
	SHARPNESS_EXT_DEFAULT = 0,
	SHARPNESS_EXT_PLUS_1,
	SHARPNESS_EXT_PLUS_2,
	SHARPNESS_EXT_PLUS_3,
	SHARPNESS_EXT_PLUS_4,
	SHARPNESS_EXT_MAX,
};
...
#define V4L2_CID_CAMERA_FACTORY_EEP_WRITE_VERSION		(V4L2_CID_CAMERA_CLASS_BASE + 41)
#define V4L2_CID_CAMERA_FACTORY_EEP_WRITE_SN			(V4L2_CID_CAMERA_CLASS_BASE + 42)
...
#define V4L2_CID_CAMERA_AUTO_FOCUS_DONE			(V4L2_CID_PRIVATE_BASE+133)
...
enum set_Factory_Eepwrite_Cmd {
	FACTORY_EEPWRITE_CHECK = 0,
	FACTORY_EEPWRITE_REPAIR = 1,
	FACTORY_EEPWRITE_STEP1 = 2,
	FACTORY_EEPWRITE_STEP2 = 3,
	FACTORY_EEPWRITE_STEP3 = 4,
	FACTORY_EEPWRITE_STEP4 = 5,
	FACTORY_EEPWRITE_STEP0 = 6,
	FACTORY_EEPWRITE_AP = 7,
	FACTORY_EEPWRITE_ISP = 8,
	FACTORY_EEPWRITE_SN = 9,
	FACTORY_EEPWRITE_OIS_SHIFT = 10,
};
...
/*USE_S5K6A3_BINNING_2X2*/
#define V4L2_CID_IS_S_MODE_CHANGE		(V4L2_CID_FIMC_IS_BASE + 664)
enum sensor_mode {
	IS_MODE_FULL,
	IS_MODE_BINNING_2X2
};
#define V4L2_CID_IS_MIPI_SETTLE		(V4L2_CID_FIMC_IS_BASE + 665)
...
#define V4L2_CID_FACTORY_FW_CHECK	(V4L2_CID_FIMC_IS_ISP_DBG_BASE + 8)
#define V4L2_CID_FACTORY_D4_CMD		(V4L2_CID_FIMC_IS_ISP_DBG_BASE + 9)
#define V4L2_CID_NOTI_DATA_GET		(V4L2_CID_FIMC_IS_ISP_DBG_BASE + 10)
#define V4L2_CID_EXIF_TIME_MODEL	(V4L2_CID_FIMC_IS_ISP_DBG_BASE + 11)
#define V4L2_CID_CAMERA_DISTANCE_SCALE	(V4L2_CID_FIMC_IS_ISP_DBG_BASE + 12)
#define V4L2_CID_EXIF_GPS	(V4L2_CID_FIMC_IS_ISP_DBG_BASE + 13)
