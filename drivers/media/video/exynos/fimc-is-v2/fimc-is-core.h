...
#define FIMC_IS_POWEROFF_TIMEOUT	((2*HZ)/(10))
...
#define FIMC_IS_DEBUG_REGION_ADDR	0x00840000//0x0084B000
...
#define BUS_LOCK_FREQ_L0	200136
#define BUS_LOCK_FREQ_L1	200133
#define BUS_LOCK_FREQ_L2	133133
#define BUS_LOCK_FREQ_L3	133100
#define BUS_LOCK_FREQ_L4	100100
#define BUS_LOCK_FREQ_L5	8080
#define BUS_LOCK_FREQ_L6	5050
...
enum fimc_is_state_flag {
	...
	IS_ST_SET_ZOOM,
	IS_ST_CHANGE_SENSOR_MODE,	/*USE_S5K6A3_BINNING_2X2*/
	IS_ST_END
};
...
enum sensor_name {
	...
	SENSOR_NAME_S5K6A3_BINNING_2X2	= 34,	/*USE_S5K6A3_BINNING_2X2*/
...
enum ae_lock_state {
	...
	FIMC_IS_AE_LOCKED	= 1,
	FIMC_IS_AE_SETCONFIG = 2
};

enum awb_lock_state {
	FIMC_IS_AWB_UNLOCKED	= 0,
	FIMC_IS_AWB_LOCKED	= 1,
	FIMC_IS_AWB_SETCONFIG = 2
};
...
struct fimc_is_dev {
	...
	int				mipi_settle;	/* MIPI settle USE_S5K6A3_BINNING_2X2*/
};
