...
static const struct isp_param init_val_isp_preview_still = {
	...
	.otf_input = {
		...
		.binning_ratio_x = 1000,  //doen't use sensor binning
...
static const struct fd_param init_val_fd_preview_still = {
	...
	.config = {
		...
		.eye_detect = FD_CONFIG_EYES_DETECT_DISABLE,
...
void fimc_is_hw_open_sensor(struct fimc_is_dev *dev, u32 id, u32 sensor_index)
{
	...
	printk("fimc_is_hw_open_sensor sensor_index %d\n", sensor_index);

	switch (sensor_index) {
	case SENSOR_S5K6A3_CSI_A:
		sensor_ext = (struct sensor_open_extended *)
						&dev->is_p_region->shared;
		sensor_ext->actuator_type.name= ACTUATOR_NAME_DWXXXX;
        sensor_ext->actuator_type.type = SE_I2C;    
        sensor_ext->actuator_type.setting.i2c.channel = 0;
        sensor_ext->flash_type.name= FLADRV_NAME_NOTHING; 
        sensor_ext->fRom_type.name = FROMDRV_NAME_NOTHING;
		sensor_ext->mclk = 0;
	...
	case SENSOR_S5K6A3_CSI_B:
		...
		sensor_ext->actuator_type.name= ACTUATOR_NAME_DWXXXX;
        sensor_ext->actuator_type.type = SE_I2C;    
        sensor_ext->actuator_type.setting.i2c.channel = 1;
        sensor_ext->flash_type.name= FLADRV_NAME_NOTHING; 
        sensor_ext->fRom_type.name = FROMDRV_NAME_NOTHING;
		sensor_ext->mclk = 0;
		sensor_ext->mipi_lane_num = 0;
...
#ifdef CONFIG_VIDEO_EXYNOS_FIMC_IS_BINNING_2X2
		writel(SENSOR_NAME_S5K6A3_BINNING_2X2, dev->regs + ISSR2);
#else
		writel(SENSOR_NAME_S5K6A3, dev->regs + ISSR2);
#endif
	...
	case SENSOR_S5K4E5_CSI_A:
		sensor_ext = (struct sensor_open_extended *)
						&dev->is_p_region->shared;
		sensor_ext->actuator_type.name= ACTUATOR_NAME_AD5823;
        sensor_ext->actuator_type.type = SE_I2C;    
        sensor_ext->actuator_type.setting.i2c.channel = 0;
        sensor_ext->flash_type.name= FLADRV_NAME_NOTHING; 
        sensor_ext->fRom_type.name = FROMDRV_NAME_NOTHING;
...
void fimc_is_hw_set_init(struct fimc_is_dev *dev)
{
	...
	case ISS_PREVIEW_STILL:
		...
		IS_ISP_SET_PARAM_OTF_INPUT_FRAMETIME_MAX(dev,
			init_val_isp_preview_still.otf_input.frametime_max);
#ifdef CONFIG_VIDEO_EXYNOS_FIMC_IS_BINNING_2X2
		IS_ISP_SET_PARAM_OTF_INPUT_BINNING_RATIO_X(dev,
			init_val_isp_preview_still.otf_input.binning_ratio_x);
		IS_ISP_SET_PARAM_OTF_INPUT_BINNING_RATIO_Y(dev,
			init_val_isp_preview_still.otf_input.binning_ratio_y);
#endif
		...
		IS_ISP_SET_PARAM_AA_AF_REGION(dev, 
			init_val_isp_preview_still.aa.use_af_region);
		IS_ISP_SET_PARAM_AA_AF_REGION_L(dev, 
			init_val_isp_preview_still.aa.af_region_left);
		IS_ISP_SET_PARAM_AA_AF_REGION_T(dev,
			init_val_isp_preview_still.aa.af_region_top);
		IS_ISP_SET_PARAM_AA_AF_REGION_R(dev,
			init_val_isp_preview_still.aa.af_region_right);
		IS_ISP_SET_PARAM_AA_AF_REGION_B(dev, 
			init_val_isp_preview_still.aa.af_region_bottom);
	...
	case ISS_PREVIEW_VIDEO:
...
#ifdef CONFIG_VIDEO_EXYNOS_FIMC_IS_BINNING_2X2
		IS_ISP_SET_PARAM_OTF_INPUT_BINNING_RATIO_X(dev,
			init_val_isp_preview_video.otf_input.binning_ratio_x);
		IS_ISP_SET_PARAM_OTF_INPUT_BINNING_RATIO_Y(dev,
			init_val_isp_preview_video.otf_input.binning_ratio_y);
#endif
		IS_ISP_SET_PARAM_OTF_INPUT_ERR(dev,
		...
		IS_ISP_SET_PARAM_AA_AF_REGION(dev, 
			init_val_isp_preview_video.aa.use_af_region);
		IS_ISP_SET_PARAM_AA_AF_REGION_L(dev, 
			init_val_isp_preview_video.aa.af_region_left);
		IS_ISP_SET_PARAM_AA_AF_REGION_T(dev,
			init_val_isp_preview_video.aa.af_region_top);
		IS_ISP_SET_PARAM_AA_AF_REGION_R(dev,
			init_val_isp_preview_video.aa.af_region_right);
		IS_ISP_SET_PARAM_AA_AF_REGION_B(dev, 
			init_val_isp_preview_video.aa.af_region_bottom);		
		IS_ISP_SET_PARAM_AA_ERR(dev,
	...
	case ISS_CAPTURE_STILL:
...
#ifdef CONFIG_VIDEO_EXYNOS_FIMC_IS_BINNING_2X2
		IS_ISP_SET_PARAM_OTF_INPUT_BINNING_RATIO_X(dev,
			init_val_isp_capture.otf_input.binning_ratio_x);
		IS_ISP_SET_PARAM_OTF_INPUT_BINNING_RATIO_Y(dev,
			init_val_isp_capture.otf_input.binning_ratio_y);
#endif
		IS_ISP_SET_PARAM_OTF_INPUT_ERR(dev,
		...
		IS_ISP_SET_PARAM_AA_AF_REGION(dev, 
			init_val_isp_capture.aa.use_af_region);
		IS_ISP_SET_PARAM_AA_AF_REGION_L(dev, 
			init_val_isp_capture.aa.af_region_left);
		IS_ISP_SET_PARAM_AA_AF_REGION_T(dev,
			init_val_isp_capture.aa.af_region_top);
		IS_ISP_SET_PARAM_AA_AF_REGION_R(dev,
			init_val_isp_capture.aa.af_region_right);
		IS_ISP_SET_PARAM_AA_AF_REGION_B(dev, 
			init_val_isp_capture.aa.af_region_bottom);			
	...
	case ISS_CAPTURE_VIDEO:
...
#ifdef CONFIG_VIDEO_EXYNOS_FIMC_IS_BINNING_2X2
		IS_ISP_SET_PARAM_OTF_INPUT_BINNING_RATIO_X(dev,
			init_val_isp_camcording.otf_input.binning_ratio_x);
		IS_ISP_SET_PARAM_OTF_INPUT_BINNING_RATIO_Y(dev,
			init_val_isp_camcording.otf_input.binning_ratio_y);
#endif
		IS_ISP_SET_PARAM_OTF_INPUT_ERR(dev,
		...
		IS_ISP_SET_PARAM_AA_AF_REGION(dev, 
			init_val_isp_camcording.aa.use_af_region);
		IS_ISP_SET_PARAM_AA_AF_REGION_L(dev, 
			init_val_isp_camcording.aa.af_region_left);
		IS_ISP_SET_PARAM_AA_AF_REGION_T(dev,
			init_val_isp_camcording.aa.af_region_top);
		IS_ISP_SET_PARAM_AA_AF_REGION_R(dev,
			init_val_isp_camcording.aa.af_region_right);
		IS_ISP_SET_PARAM_AA_AF_REGION_B(dev, 
			init_val_isp_camcording.aa.af_region_bottom);		
