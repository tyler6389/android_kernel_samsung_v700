		...
		int (*bind)(struct usb_gadget *))
{
	...
	|| defined(CONFIG_MFD_MAX8997) || defined(CONFIG_MFD_MAX77686) || defined(CONFIG_MACH_WATCH)
...
#if defined(CONFIG_USB_EXYNOS_SWITCH) || defined(CONFIG_MFD_MAX77693)\
	|| defined(CONFIG_MFD_MAX8997) || defined(CONFIG_MFD_MAX77686) || defined(CONFIG_MUIC_MAX14577)
	/* Nothing to do */
#else
		udc_disable(dev);
#endif
