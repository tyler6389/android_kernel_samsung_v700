...
#define FB_CLK_OFF			0
#define FB_CLK_ON			1
#define FB_CLK_WAIT_OFF		2
#ifdef CONFIG_FB_I80_POWER_GATING
#define FB_PWR_OFF			3
#endif
#endif

#define FB_DEACTIVATE_REQ	0
#define FB_ACTIVATE_REQ		1

#define GATE_CLK_REQ			0
#define GATE_PWR_REQ			1
...
struct s3cfb_global {
	...
	unsigned int draw_req;
	unsigned int vsync_cnt;
#endif

#ifdef CONFIG_FB_SUPPORT_ALPM
	unsigned int alpm_buf_cnt;
#endif

#ifdef CONFIG_FB_I80_CLOCK_GATING
	struct workqueue_struct *clk_workqueue;
	...
	struct delayed_work pwr_delayed_work;
	int pwr_stat;
#endif
#endif
...
extern int s3cfb_set_i80_timing(struct s3cfb_global *ctrl);
...
#ifdef CONFIG_FB_I80_CLOCK_GATING
extern int s3cfb_activate_req(struct s3cfb_global *fbdev, int force);
extern int s3cfb_deactivate_req(struct s3cfb_global *fbdev, int force, int req);
#endif
#endif /* _S3CFB_H */
