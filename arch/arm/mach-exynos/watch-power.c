/*
 * watch-power.c - Power Management of Watch Project base T0
 *
...
struct max14577_regulator_data max14577_regulators[] = {
	{MAX14577_SAFEOUT1, &safeout1_init_data,},
	{MAX14577_SAFEOUT2, &safeout2_init_data,},
//	{MAX14577_CHARGER, &charger_init_data,},
};
#endif /* CONFIG_MFD_MAX14577 */
...
static struct regulator_consumer_supply ldo5_supply[] = {
	REGULATOR_SUPPLY("micbias_ldo_2.8V", NULL),
};
...
#if defined(CONFIG_WATCH_01_BD) || defined(CONFIG_WATCH_02_BD)
static struct regulator_consumer_supply ldo19_supply[] = {
...
#if defined(CONFIG_WATCH_00_BD)
static struct regulator_consumer_supply ldo22_supply[] = {
	REGULATOR_SUPPLY("vsd_2.8V", NULL),
};
#else
static struct regulator_consumer_supply ldo23_supply[] = {
	REGULATOR_SUPPLY("bt_3.0V", NULL),
};
#endif

static struct regulator_consumer_supply ldo24_supply[] = {
	REGULATOR_SUPPLY("vt_cam_sensor_a2.8v", NULL),
};
...
REGULATOR_INIT(ldo3, "VCC_1.8V_AP", 1800000, 1800000, 1, 0, 0);
REGULATOR_INIT(ldo5, "MICBIAS_2.8V", 2800000, 2800000, 0,
		REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo8, "VMIPI_1.0V", 1000000, 1000000, 1,
	       REGULATOR_CHANGE_STATUS, 0);
REGULATOR_INIT(ldo9, "CAM_ISP_MIPI_1.2V", 1200000, 1200000, 0,
...
REGULATOR_INIT(ldo19, "CAM_AF_2.8V", 2800000, 2800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
#endif
REGULATOR_INIT(ldo21, "TSP_AVDD_3.3V", 3300000, 3300000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
#if defined(CONFIG_WATCH_00_BD)
REGULATOR_INIT(ldo22, "VSD_2.8V", 2800000, 2800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
#else
REGULATOR_INIT(ldo22, "VCC_3.3V_LCD", 3300000, 3300000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo23, "BT_3.0V", 3000000, 3000000, 1,
	       REGULATOR_CHANGE_STATUS, 0);
#endif
REGULATOR_INIT(ldo24, "VT_CAM_SENSOR_A2.8V", 2800000, 2800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
REGULATOR_INIT(ldo25, "TSP_VDD_1.8V", 1800000, 1800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
#if defined(CONFIG_WATCH_00_BD)
REGULATOR_INIT(ldo26, "VDD_MOT_2.7V", 2700000, 2700000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
#else
REGULATOR_INIT(ldo20, "VDD_MOT_2.7V", 1100000, 3100000, 0,
	       REGULATOR_CHANGE_VOLTAGE |REGULATOR_CHANGE_STATUS, 1);
#endif

#if defined (CONFIG_WATCH_02_BD)
REGULATOR_INIT(ldo26, "VDD_LCD_1.8V", 1800000, 1800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
#endif
REGULATOR_INIT(ldo27, "VT_CAM_1.8V", 1800000, 1800000, 0,
	       REGULATOR_CHANGE_STATUS, 1);
#if defined(CONFIG_WATCH_00_BD)
REGULATOR_INIT(ldo28, "VCC_3.3V_LCD", 3300000, 3300000, 0,
	      REGULATOR_CHANGE_STATUS, 1);
#endif
...
#if defined(CONFIG_WATCH_00_BD) || defined (CONFIG_WATCH_02_BD)
