...
static struct platform_device bcm4335_bluetooth_device = {
	...
	|| defined(CONFIG_KEYBOARD_TC370L_TOUCHKEY)
...
static struct platform_device *midas_devices[] __initdata = {
	...
	&s3c_device_i2c8,
#endif
#if defined(CONFIG_SENSORS_CM3663) || defined(CONFIG_SENSORS_BH1721) \
	|| defined(CONFIG_SENSORS_CM36651) || defined(CONFIG_SENSORS_GP2A) \
	|| defined(CONFIG_SENSORS_TMD27723)
	&s3c_device_i2c9,
#endif
#ifdef CONFIG_SENSORS_AK8975C
	&s3c_device_i2c10,
...
#endif
#if (CONFIG_VIDEO_SAMSUNG_MEMSIZE_FIMC1 > 0)
