...
#define S3C_VIDCON3		(0x000C)	/* Video control 3 */
...
#define S3C_CGAINCON		(0x01C0)	/* Speifies color gain control register */
...
#define S3C_GAMMALUT_START	(0x037C)	/* Spedified gamma LUT data */
...
#define SWTRGCMD_I80				(1 << 1)
#define TRGMODE_I80				(1 << 0)
